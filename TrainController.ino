...
//
//	Train Controller V0.4.1
//	-----------------------
//
//	The revised version of the "Grey Box" DCC solution where the new,
//	more open firmware architecture was developed.
//
//	At the moment this version has only be deployed into an Arduino
//	Mega2560 but code optimisation and more dynamic use of SRAM looks
//	like it may be possible to install in an UNO/Nano.  Testing is
//	required.
//
//	This firmware provides the ability to run DCC trains in a free
//	standing mode (in addition to computer based control via USB).
//
//	Support for a programming track is planned but not yet done.
//
